...
//    	String emp_id=session.getAttribute("emp_id").toString();
    ...
    public int morrisDataTaskCompleted(String rule_id, int completed) throws SQLException
    	{
    		return completed;
    	}

    	public int morrisDataTaskPending(String rule_id, int pending) throws SQLException
    	{
    		pending=100-pending;
    		return pending;
    	}
